...
static int BatteryService_BalanceMode_StartRatio = 9; // divid 10  is the real StartRatiio
...
{
	int pad_charging_sts = POWER_SUPPLY_STATUS_UNKNOWN;
...
{
	int dock_charging_sts = POWER_SUPPLY_STATUS_UNKNOWN;
...
{
    printk("%s, hwid=%d,src=%d\n",__FUNCTION__,g_A60K_hwID,chg_src );
