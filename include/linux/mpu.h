...
#define MPU_EVENT_NOTIFY_PHONE 0
#define MPU_EVENT_NOTIFY_PAD 1
#define ASUS_MPU_READ_ORIENT_STASUS _IOR(MPU_IOCTL, 0x50, int)
#define ASUS_MPU_GET_MLDL_CFG _IOR(MPU_IOCTL, 0x51, struct mldl_cfg)
//ASUS_BSP --- Jason Chang "dynamic change orientation"
//ASUS_BSP +++ Jason Chang "Ignore read g sensor when calibration"
#define ASUS_MPU_SET_CALIBRATION_MODE _IOW(MPU_IOCTL, 0x52, int)
//ASUS_BSP --- Jason Chang "Ignore read g sensor when calibration"
#define ASUS_CHECK_COMPASS_CALIBRATION_STATUS _IOR(MPU_IOCTL, 0x53, int)
#endif				/* __MPU_H_ */
